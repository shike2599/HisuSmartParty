$(function(){
    ...
    $.get(gloablePath+"/party-app-education-front/res/readonly/listTopicContent?requestUser=hotel&requestPassword=123456",{cateCode:3004,pageNo:1,pageSize:5},function(data){
        if(data.resultCode == 200){
            ...
            $(".newsList .partyNew_contentVideo").on("click",function(){
                ...
                window.location.href="threeSessionDetail.html";
            })
        }
    })
    ...
    var page = 5; //每次加载5条
    function pullOnLoad() {
        $.get(gloablePath+"/party-app-education-front/res/readonly/listTopicContent?requestUser=hotel&requestPassword=123456",{cateCode:3004,pageNo:num,pageSize:page},function(data){
            if(data.resultCode == 200){
                console.log(data);
