...
public class CommentDialog extends Dialog implements
    ...
    private void initView() {
        ...
        if (mCommentItem != null
                && userId.equals(
                mCommentItem.getUserId())&& !"".equals(mCommentItem.getId() )) {
        ...
        switch (v.getId()) {
            ...
            case R.id.deleteTv:
                if (mPresenter != null && mCommentItem != null) {
                    if(mCommentItem.getId() != null && !"".equals(mCommentItem.getId())){
                        mPresenter.deleteComment(mCirclePosition,Integer.parseInt(mCommentItem.getId()),commentPosition);
                    }
                }
                dismiss();
                break;
