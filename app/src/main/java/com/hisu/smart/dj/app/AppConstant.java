...
public class AppConstant {
    ...
    public static final String USER_PHONE = "user_phone";           //手机号
    ...
    //党员个人信息
    public static final String MEMBER_ID = "member_id";  //党员序号
    public static final String MEMBER_NAME = "member_name"; //党员名称
    public static final String MEMBER_CODE = "member_code"; //党员编号
    public static final String MEMBER_PHONE = "member_phone";  //联系电话
    public static final String MEMBER_IDCARD = "member_idCard";  //党员身份证号
    public static final String MEMBER_SEX = "member_sex";  //性别 0:女 1:男
    public static final String MEMBER_PARTYBRANCH_ID = "member_partyBranchId";  //所属支部序号
    public static final String MEMBER_STATUS = "member_status";  //党员性质 0:在职 1:退休 2:农民
    public static final String MEMBER_INTEGRAL = "member_integral";  //党员积分
