...
public class MultiImageView extends LinearLayout {
	...
	private void initImageLayoutParams() {
        ...
        //pxOneMaxWandH
		onePicPara = new LayoutParams( DisplayUtil.dip2px(150),  DisplayUtil.dip2px(180));
	...
	private void initView() {
		...
		if (imagesList.size() == 1) {
			RelativeLayout oneRelativeLayout = new RelativeLayout(getContext());
			addView(oneRelativeLayout);
			oneRelativeLayout.setGravity(Gravity.CENTER);
			oneRelativeLayout.addView(createImageView(0, false));
		} else {
