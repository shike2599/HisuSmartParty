package com.hisu.smart.dj.ui.zone.viewholder;
...
import com.hisu.smart.dj.ui.zone.adapter.CommentAdapter;
...
import com.hisu.smart.dj.ui.zone.widget.CommentDialog;
import com.hisu.smart.dj.ui.zone.widget.CommentListView;
import com.hisu.smart.dj.ui.zone.widget.ExpandableTextView;
import com.hisu.smart.dj.ui.zone.widget.FavortListView;
import com.hisu.smart.dj.ui.zone.widget.MultiImageView;
import com.hisu.smart.dj.utils.ZoneUtils;
...
public class ZoneViewHolder extends RecyclerView.ViewHolder {
    ...
    private final static String TAG = "ZoneViewHolder";
    ...
    public void setData(CircleZonePresenter mPresenter2, CircleItem circleItem2, final int position2){
        ...
        Log.i(TAG,"hasFavort==========================="+hasFavort);
        Log.i(TAG,"hasComment==========================="+hasComment);
            ...
            if (hasComment) {
                ...
                commentList.setOnItemClick(new CommentListView.OnItemClickListener() {
                    ...
                    public void onItemClick(int commentPosition) {
                        ...
                        String userId = com.hisu.smart.dj.app.AppConfig.getInstance().getInt(AppConstant.USER_ID,-1)+"";
                        if ( userId.equals(commentItem.getUserId())) {//复制或者删除自己的评论
...
//            snsBtn.setText("");
        ...
        snsBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                String nickName = AppConfig.getInstance().getString(AppConstant.NICK_NAME,"GaoFeng");
                String userId = AppConfig.getInstance().getInt(AppConstant.USER_ID,-1)+"";
                comment(nickName,""+circleItem.getId(), userId, position);
            }
        });
...
//        });
    ...
    private void favort(int publishId, int publishUserId, int circlePosition, String mTitle, View view) {
        if (System.currentTimeMillis() - mLasttime < 700)//防止快速点击操作
            return;
        mLasttime = System.currentTimeMillis();
        if (mPresenter != null) {
            if ("赞".equals(mTitle)) {
                mPresenter.addFavort(publishId, publishUserId,AppConfig.getInstance().getInt(AppConstant.MEMBER_ID,-1), circlePosition, view);
            } else {//取消点赞
                mPresenter.deleteFavort(publishId,circlePosition);
            }
        }
    }
    /**
     * 评论
     */
    private void comment(String name,String publishId, String publishUserId, int circlePosition) {
        if (mPresenter != null) {
            CommentConfig config = new CommentConfig();
