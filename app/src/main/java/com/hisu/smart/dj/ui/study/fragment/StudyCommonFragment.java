 ...
 * @author lichee
 */
public class StudyCommonFragment extends BaseFragment<StudyCommonPresenter, StudyCommonModel> implements StudyCommonContract.View, OnLoadMoreListener, OnRefreshListener {
